...
class ChannelState:
  ...
  def start_response_delay_timer(self):
    self.response_delay_timer = Timer(self.RESPONSE_DELAY_INTERVAL, self.send_response, [f"It has been {self.RESPONSE_DELAY_INTERVAL} seconds without anyone sending a message. You should send one."])
